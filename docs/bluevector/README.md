...
16. [Domaine FTTH et architecture KML/KMZ V1](FTTH_KMZ_DOMAIN_AND_ARCHITECTURE.md)
17. [Architecture de déploiement et sécurité V1](V1_DEPLOYMENT_SECURITY_ARCHITECTURE.md)
18. [Corpus documentaire et formation V1](V1_DOCUMENTATION_AND_TRAINING_PLAN.md)
19. [Plan d’exécution BlueVector et Agent Orienteur — 2 septembre 2026](EXECUTION_PLAN_2026-09-02.md)
20. [Apports de recherche FTTH, terrain et Agent Orienteur](RESEARCH_INTAKE_2026-09-02.md)
