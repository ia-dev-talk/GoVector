  ...
  return (
    <button
      ...
      className={[
        'st3-warehouse-row',
        selected
          ? 'st3-warehouse-row--selected'
          : '',
      ].join(' ')}
      onClick={() => onSelect(id)}
    >
      <span className="st3-warehouse-icon">
        <WarehouseIcon />
      </span>
    ...
    return (
      <aside className="st3-warehouse-rail st3-warehouse-rail--collapsed">
        <button
          type="button"
          onClick={onToggle}
          title="Déployer les dépôts"
          aria-label="Déployer les dépôts"
        >
