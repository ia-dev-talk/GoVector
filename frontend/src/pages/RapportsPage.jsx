/**
 * RapportsPage — centre analytique FTTH BlueVector V3.
 *
 * Les métriques proviennent exclusivement des interventions historiques,
 * des techniciens du dashboard et du centre d’export existant.
 */
...
export default function RapportsPage({
  ...
  const [previousJobs, setPreviousJobs] =
    useState([]);
  ...
  const [resultLimitReached, setResultLimitReached] =
    useState(false);
    ...
    useCallback(
      (intent = null) => {
        ...
        try {
          ...
          // La navigation directe reste disponible.
        }
